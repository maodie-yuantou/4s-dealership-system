...
let pendingRequests: Array<{ resolve: (value: unknown) => void; reject: (reason?: unknown) => void; config: Record<string, unknown> }> = []
...
api.interceptors.response.use(
  function(res: AxiosResponse) { return res },
  async function(err) {
...
export const carImages: Record<string, Record<string, string>> = {
...
export function getCarImage(brand: string, model: string, imageUrl?: string): string {
...
export function getCarPlaceholder(brand: string, model?: string): string {
